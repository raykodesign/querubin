document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- MAQUINA DE ESCRIBIR ---
    const welcomeMsg = "A veces las cosas no salen como queremos, pero siempre saldra como era necesario vivirlas para poder crecer....... confia en tu proceso aunque no lo entiendas.";
    ...
    window.openModal = function(modalId) {
        ...
        // REINICIAR GALERÍA A LA PRIMERA FOTO AL ABRIR
        if(modalId === 'modal-gallery') {
            galleryIndex = 0; // Forzar índice 0
            updateGallery3D();
        }
        ...
        if(modalId === 'modal-vip') {
            ...
            // Opcional: Reiniciar también la VIP
            vipIndex = 0; 
        }
    };
    ...
    const galleryImages = [
        "https://xatimg.com/image/wWsjji7seNKa.jpg",
        ...
        "https://xatimg.com/image/i4HMQJWpUDny.jpg",
        "https://xatimg.com/image/03bBosW62eMf.jpg",
    ];
    ...
    // --- 5. MÚSICA & EXTRAS ---
    const playlist = [
        { title: "Everybody Wants To Rule The World", artist: "", src: "audio/Everybody Wants To Rule The World.mp3" },
    ];
